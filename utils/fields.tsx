...
export const NO_SERVER_FOUND_ALERT:ReactElement = <Alert severity={"error"}>{NO_SERVER_FOUND_TEXT}</Alert>
export const ERROR_NOT_WORKED_RECOMMENDATIONS_ALERT:ReactElement = <Alert>{ERROR_NOT_WORKED_RECOMMENDATIONS_TEXT}</Alert>
export const ERROR_NO_DATA_ALERT:ReactElement = <Alert>{ERROR_NO_DATA}</Alert>
export const SUCCESS_LOGGED_IN_ALERT:ReactElement = <Alert severity={"success"}>{SUCCESS_LOGGED_IN}</Alert>

export const ERROR_ACCOUNT_SUSPENDED_ALERT:ReactElement = <Alert severity={"error"}>{ERROR_ACCOUNT_SUSPENDED}</Alert>;